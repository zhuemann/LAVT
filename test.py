...
def evaluate(model, data_loader, bert_model, device):
    ...
    filepath = os.path.join("/UserData/Zach_Analysis/result_logs/candid_result/image_text_segmentation_for_paper/higher_res_for_paper/LAVT_v50/prediction_dataframe_test" + '.xlsx')
